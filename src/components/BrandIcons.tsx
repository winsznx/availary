/**
 * Small inline brand glyphs. Lucide no longer ships brand icons, so the GitHub
 * and X marks are inlined here as real, recognizable logos (currentColor fill).
 */
